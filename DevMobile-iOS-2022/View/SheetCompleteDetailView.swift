...
struct SheetCompleteDetailView: View {
    ...
    //@StateObject var dataSheetComplete2: SheetCompleteListViewModel = SheetCompleteListViewModel()
                                        ...
                                        if viewModel.Nbre_couverts != nil {
                                            Button(action :{
                                                ...
                                                ForEach( _listvm2.vms,id: \.ingredient.nomListeIngredients) {
                                                    vm in
                                                    vm.quantites.split(separator: ",").reduce{Int($0)!*(viewModel.Nbre_couverts / oldcouvert)}
                                                }
